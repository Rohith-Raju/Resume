...
\section{Projects (clicking on the sub-heading will take you to the project)}
  ...
  {Meshery is the cloud native management plane offering lifecycle, configuration, and performance management of Kubernetes, service meshes, and your workloads. A CNCF project}
  \resumeSubItem {\href{https://github.com/rohith-raju/React-Page-Transitions}{ React-Page-Transitions (Ongoing) }}
  {React-Page-Transition is a react library that can be installed to import page transitions into your React applications }
