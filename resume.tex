    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Node Script}
          {evised a method to seamlessly transfer data from an xlsx file into the database, streamlining the process. Skillfully resolved various bugs and challenges associated with backend endpoints, ensuring smooth functionality and enhanced user experience.}
        \resumeItem{Skills:}
        { Node.Js , Express }
      \resumeItemListEnd
