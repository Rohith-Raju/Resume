...
\section{Experience}
  ...
  {Contributed to the development of a Falco rules playground as part of the Google Summer of Code program. Worked on creating a web-app, leveraging WebAssembly. 
  ...
  {Internship Trainee }{July 2022 - December 2022 6 mos}
  \resumeItemListStart
  \resumeItem{Messaging Team}
  {Worked on spring boot microservices and internal tools, used for push-to-talk communications.}
  \resumeItem{Skills:}
